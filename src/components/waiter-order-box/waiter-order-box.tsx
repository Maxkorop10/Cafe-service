          ...
          <div className="flex flex-row">
            {in_process && (
              <button
                ...
                className="flex items-center rounded-lg text-sm font-medium bg-blue-50 text-blue-600 border border-blue-100 hover:bg-blue-100 transition-colors duration-200"
              >
